...
| RTI-F01 | Release-truth checker (`scripts/check_repo_contract.py`) | 1 | P0 | Not started |
| RTI-F02 | Release-truth autofixer (`scripts/sync_repo_contract.py --write`) | 1 | P0 | Not started |
