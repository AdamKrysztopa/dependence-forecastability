...
| --- | --- | --- | --- | --- |
| Package facade | `src/forecastability/__init__.py` | [../public_api.md](../public_api.md) | [../../README.md](../../README.md), [../versioning.md](../versioning.md) | Active |
...
| Source layout | `src/forecastability/` | [../code/module_map.md](../code/module_map.md) | [../architecture.md](../architecture.md) | Active |
| CLI | `src/forecastability/adapters/cli.py`, `pyproject.toml` | [../../README.md](../../README.md) | [../surface_guide.md](../surface_guide.md), [../quickstart.md](../quickstart.md) | Active |
| Dashboard | `src/forecastability/adapters/dashboard.py`, `pyproject.toml` | [../../README.md](../../README.md) | [../surface_guide.md](../surface_guide.md) | Active |
| HTTP API | `src/forecastability/adapters/api.py` | [../api_contract.md](../api_contract.md) | [../../README.md](../../README.md), [../surface_guide.md](../surface_guide.md) | Active |
...
| Stability policy | `pyproject.toml`, facade docs, runtime entry points | [../versioning.md](../versioning.md) | [../public_api.md](../public_api.md) | Active |
| Architecture narrative | `src/forecastability/` and architecture tests | [../architecture.md](../architecture.md) | [../code/module_map.md](../code/module_map.md) | Active |
...
| `docs/archive/theory/interpretation_patterns.md` | Checklist-style theory page that overstated project heuristics as active theory documentation | [../wording_policy.md](../wording_policy.md), [../limitations.md](../limitations.md), and active interpretation surfaces |
