...
# forecastability.use_cases.pipeline
...
_CANONICAL_MODULE = "forecastability.use_cases.pipeline"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.pipeline.pipeline is deprecated in v0.5.0; "
        "use forecastability.use_cases.pipeline instead. "
