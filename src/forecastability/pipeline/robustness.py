...
# forecastability.use_cases.robustness
...
_CANONICAL_MODULE = "forecastability.use_cases.robustness"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.pipeline.robustness is deprecated in v0.5.0; "
        "use forecastability.use_cases.robustness instead. "
