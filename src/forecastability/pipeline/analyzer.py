...
_CANONICAL_MODULE = "forecastability.use_cases.analyzer"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.pipeline.analyzer is deprecated in v0.5.0; "
        "use forecastability.use_cases.analyzer instead. "
