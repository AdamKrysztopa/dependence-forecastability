...
# forecastability.services.diagnostics.cmi_ksg
...
_CANONICAL_MODULE = "forecastability.services.diagnostics.cmi_ksg"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.cmi_ksg is deprecated in v0.5.0; "
        "use forecastability.services.diagnostics.cmi_ksg instead. "
