...
_CANONICAL_MODULE = "forecastability.services.diagnostics.surrogates"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.surrogates is deprecated in v0.5.0; "
        "use forecastability.services.diagnostics.surrogates instead. "
