...
_CANONICAL_MODULE = "forecastability.services.diagnostics.predictive_information_gain"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.predictive_information_gain is deprecated in v0.5.0; "
        "use forecastability.services.diagnostics.predictive_information_gain instead. "
