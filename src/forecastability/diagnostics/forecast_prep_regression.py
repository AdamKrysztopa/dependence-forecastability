...
# forecastability.use_cases.diagnostics.forecast_prep_regression
...
_CANONICAL_MODULE = "forecastability.use_cases.diagnostics.forecast_prep_regression"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.forecast_prep_regression is deprecated in v0.5.0; "
        "use forecastability.use_cases.diagnostics.forecast_prep_regression instead. "
