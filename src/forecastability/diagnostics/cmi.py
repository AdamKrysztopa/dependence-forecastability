...
_CANONICAL_MODULE = "forecastability.services.diagnostics.cmi"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.cmi is deprecated in v0.5.0; "
        "use forecastability.services.diagnostics.cmi instead. "
