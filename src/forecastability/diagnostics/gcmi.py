...
_CANONICAL_MODULE = "forecastability.services.diagnostics.gcmi"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.gcmi is deprecated in v0.5.0; "
        "use forecastability.services.diagnostics.gcmi instead. "
