...
# forecastability.use_cases.diagnostics.lag_aware_mod_mrmr_regression
...
_CANONICAL_MODULE = "forecastability.use_cases.diagnostics.lag_aware_mod_mrmr_regression"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.lag_aware_mod_mrmr_regression is deprecated in v0.5.0; "
        "use forecastability.use_cases.diagnostics.lag_aware_mod_mrmr_regression instead. "
