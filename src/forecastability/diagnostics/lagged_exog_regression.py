...
# forecastability.use_cases.diagnostics.lagged_exog_regression
...
_CANONICAL_MODULE = "forecastability.use_cases.diagnostics.lagged_exog_regression"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.lagged_exog_regression is deprecated in v0.5.0; "
        "use forecastability.use_cases.diagnostics.lagged_exog_regression instead. "
