...
# forecastability.use_cases.diagnostics.routing_validation_panel
...
_CANONICAL_MODULE = "forecastability.use_cases.diagnostics.routing_validation_panel"
...
def __getattr__(name: str) -> Any:
    ...
    _warnings.warn(
        "forecastability.diagnostics.routing_validation_panel is deprecated in v0.5.0; "
        "use forecastability.use_cases.diagnostics.routing_validation_panel instead. "
