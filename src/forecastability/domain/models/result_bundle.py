...
from forecastability.domain.models.triage import AnalysisGoal, TriageResult
...
class TriageResultBundle(BaseModel):
    ...
    The bundle is additive relative to :class:`~forecastability.domain.models.triage.TriageResult`
