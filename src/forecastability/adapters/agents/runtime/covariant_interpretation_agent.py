...
This adapter mirrors :mod:`forecastability.adapters.agents.runtime.triage_agent`:
it wraps the deterministic :class:`CovariantInterpretationResult` behind a
...
from forecastability.domain.results.agent_tools.covariant_agent_results import (
...
def _create_agent(
    *, model: str, settings: InfraSettings
    ...
    def get_deterministic_interpretation(
        ...
        """Return the full deterministic interpretation as a typed Pydantic model."""
        return ctx.deps.interpretation
