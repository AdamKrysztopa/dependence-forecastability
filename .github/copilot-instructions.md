...
CLI, API, notebooks, MCP, and agents are optional access or narration layers around the same deterministic outputs. Use `README.md`, `docs/quickstart.md`, and `docs/public_api.md` as the primary intro surfaces.